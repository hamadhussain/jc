...
const Poster = () => {
  return (
    <div className=" text-white flex justify-center items-center text- w-full gap-14 px-44 ">
      <div className="post1 bg-cover bg-center bg-no-repeat relative text-white">
      ...
      <div className="post2 bg-cover bg-center bg-no-repeat relative text-white">
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="relative space-y-4 p-4">
      ...
      <div className="post3 bg-cover bg-center bg-no-repeat relative text-white">
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="relative space-y-4 p-4">
